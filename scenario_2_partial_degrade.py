        ...
        try:
            ...
            data["service_impact_predictions"] = {
                NETWORK_ID: {
                    ...
                    "reason": "Minor jitter spikes, likely transient",
                    "applications": [
                        {"name": "Teams", "activeUserPercent": 62, "impactLevel": "low", "notes": "Minor video quality fluctuation possible"},
                        {"name": "Email", "activeUserPercent": 20, "impactLevel": "none", "notes": "Operating normally"},
                        {"name": "SMB/SFTP", "activeUserPercent": 12, "impactLevel": "none", "notes": "Operating normally"}
                    ],
                    "note": "SCENARIO_2_PARTIAL_DEGRADE"
                }
            }

        ...
        try:
            ...
            data["service_impact_predictions"] = {
                NETWORK_ID: {
                    ...
                    "reason": "Sustained degradation pattern detected",
                    "applications": [
                        {"name": "Teams", "activeUserPercent": 62, "impactLevel": "high", "notes": "Video quality degraded, audio may cut out"},
                        {"name": "Email", "activeUserPercent": 20, "impactLevel": "low", "notes": "Slight delays possible"},
                        {"name": "SMB/SFTP", "activeUserPercent": 12, "impactLevel": "medium", "notes": "File transfers may timeout"}
                    ],
                    "note": "SCENARIO_3_FURTHER_DEGRADE"
                }
            }

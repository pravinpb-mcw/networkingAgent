...
start "Phoenix Server" cmd /k "cd /d "%~dp0.." && "../.wenv/Scripts/activate" && python phoenix\server.py --auto-eval --eval-interval 10"
...
start "Agent 1 - Risk Calculation" cmd /k "cd /d "%~dp0.." && "../.wenv/Scripts/activate" && python agents\agent_1_risk_calculation.py --continuous 10"

echo [5/5] Starting Agent 2 (Nearest AP - Port 5002)...
start "Agent 2 - Nearest AP" cmd /k "cd /d "%~dp0.." && "../.wenv/Scripts/activate" && python agents\agent_2_nearest_ap.py --continuous 10"

echo [6/6] Starting Agent 3 (Failover Orchestrator)...
start "Agent 3 - Failover Orchestrator" cmd /k "cd /d "%~dp0.." && "../.wenv/Scripts/activate" && python agents\agent_3_failover_suggestion.py --continuous 10"
